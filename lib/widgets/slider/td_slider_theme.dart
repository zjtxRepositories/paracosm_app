...
class TDSliderThemeData {
  ...
  ///自定义刻度值
  final Map<String, String>? customScaleValue;
  ...
  TDSliderThemeData({
    ...
    SliderThemeData? sliderThemeData,
           ...
           scaleTextStyle ??
           TextStyle(fontSize: 14, color: const Color(0xE6000000)),
       disabledScaleTextStyle =
           disabledScaleTextStyle ??
           TextStyle(fontSize: 14, color: const Color(0x42000000)),
       thumbTextStyle =
           thumbTextStyle ??
           TextStyle(fontSize: 14, color: const Color(0xE6000000)),
  ...
  TDSliderThemeData.capsule({
    ...
    SliderThemeData? sliderThemeData,
           ...
           scaleTextStyle ??
           TextStyle(fontSize: 14, color: const Color(0x35FFFFFF)),
       disabledScaleTextStyle =
           disabledScaleTextStyle ??
           TextStyle(fontSize: 14, color: const Color(0x42000000)),
       thumbTextStyle =
           thumbTextStyle ?? TextStyle(fontSize: 14, color: Colors.white),
       disabledThumbTextStyle =
           disabledThumbTextStyle ??
           TextStyle(fontSize: 14, color: const Color(0x50FFFFFF)),
       _sliderThemeData = sliderThemeData,
       _capsule = true;
  ...
  SliderThemeData normal() {
    return SliderThemeData(
      ...
      disabledActiveTrackColor: const Color(0xFFB5C7FF),
      disabledInactiveTrackColor: const Color(0xFFEEEEEE),
      activeTickMarkColor: AppColors.primary,
      inactiveTickMarkColor: const Color(0xFFDCDCDC),
      disabledActiveTickMarkColor: const Color(0xFFB5C7FF),
      disabledInactiveTickMarkColor: const Color(0xFFEEEEEE),
  ...
  SliderThemeData capsule() {
    return SliderThemeData(
      ...
      disabledThumbColor: Colors.white,
      trackHeight: 24,
      activeTrackColor: const Color(0xFF4F5470),
      inactiveTrackColor: const Color(0xFF4F5470),
      disabledActiveTrackColor: const Color(0xFFB5C7FF),
      disabledInactiveTrackColor: const Color(0xFFEEEEEE),
      overlayShape: const TDNoOverlayShape(),
      showValueIndicator: ShowValueIndicator.never,
...
class TDRoundSliderTickMarkShape extends SliderTickMarkShape {
  ...
  void paint(
    ...
    if (tickMarkRadius > 0 && themeData.showScaleValue) {
      ...
      var rect = sliderTheme.trackShape?.getPreferredRect(
        parentBox: parentBox,
        sliderTheme: sliderTheme,
      );
      if (rect != null && themeData.divisions! > 0) {
        ...
        int thumbIndex = (((thumbCenter.dx - markStart) / perWidth).round())
            .clamp(0, themeData.divisions!);
        //绘制刻度的值
        var painter = TextPainter(
          text: TextSpan(
            text: themeData.customScaleValue?[valueFormatter] ?? valueFormatter,
            style: index == thumbIndex
        ...
        painter.paint(
          context.canvas,
          Offset(x, center.dy - painter.height + 40),
        );
      }
      //绘制刻度
...
class TDRoundRangeSliderTickMarkShape extends RangeSliderTickMarkShape {
  ...
  void paint(
    ...
    if (tickMarkRadius > 0 && themeData.showScaleValue) {
      assert(themeData.divisions != null);
      var rect = sliderTheme.rangeTrackShape?.getPreferredRect(
        parentBox: parentBox,
        sliderTheme: sliderTheme,
      );
      if (rect != null && themeData.divisions! > 0) {
  ...
  void paint(
    ...
    context.canvas.drawRRect(
      RRect.fromLTRBAndCorners(
        ...
        thumbCenter.dx + 12 - additionalActiveTrackHeight,
  ...
  void paint(
    ...
    if (tickMarkRadius > 0 && themeData.showScaleValue) {
      ...
      if (rect != null && themeData.divisions! > 0) {
        ...
        painter.paint(context.canvas, Offset(x, center.dy + 20));
      }
      if (dx > rect!.left + 1 && dx < rect.right - 1) {
        ...
        context.canvas.drawLine(
          Offset(dx, themeData.sliderMeasureData.trackerRect!.top + 7),
          Offset(dx, themeData.sliderMeasureData.trackerRect!.bottom - 7),
          paint,
        );
      }
    }
