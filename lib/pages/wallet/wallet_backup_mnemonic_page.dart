...
class WalletBackupMnemonicPage extends StatefulWidget {
  final String mnemonic;
  const WalletBackupMnemonicPage({super.key,required this.mnemonic});

  @override
  State<WalletBackupMnemonicPage> createState() => _WalletBackupMnemonicPageState();
}

class _WalletBackupMnemonicPageState extends State<WalletBackupMnemonicPage> {
  ...
  void initState() {
    super.initState();
    _mnemonics = widget.mnemonic.split(" ");
    _disableScreenshot();
